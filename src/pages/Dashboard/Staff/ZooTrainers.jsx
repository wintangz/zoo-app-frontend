...
const ZooTrainers = () => {
    ...
    const labels = {
        ...
        subtitle: 'Table of Zoo Trainers',
    ...
    const actionBody = (item) => {
        return <div className='space-x-2 flex'>
            <Button icon='pi pi-pencil' className='border-amber-500 text-amber-500' rounded outlined onClick={() => navigate(`/dashboard/zoo_trainers/update/${(item.id)}`)} tooltip="Update" tooltipOptions={{ position: 'bottom' }} />
    ...
    const renderHeader = () => {
        return (
            <div className="flex justify-content-between">
                <Link to="/dashboard/zoo_trainers/create"><Button label='Create' severity='success' /></Link>
