    ...
    return (
        <>
            <div>
                ...
                >
                    <Box sx={{ ...style, width: 400 }}>
                        <h2 id="parent-modal-title">Delete ticket</h2>
                        <p id="parent-modal-description">Are you sure want to delete this ticket?</p>
            ...
            <div>
                ...
                >
                    <Box sx={{ ...style, width: 400 }}>
                        <h2 id="parent-modal-title">Delete Ticket Successfully!</h2>
                        <p id="parent-modal-description">Ticket have been delete from DataBase!</p>
                        <Button
                            color='secondary' style={{ fontSize: '0.9rem', fontWeight: 'bold' }}
                            onClick={() => {
            ...
            <Box>
                ...
                <Tooltip title="Update">
                    <Link to="/home/tickets/update" state={params.row}>
                        <IconButton
